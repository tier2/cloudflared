...
switch ($choice) {
    '1' {
        ...
        powershell -noexit -nologo -executionpolicy bypass -File C:\Cloudflared\cloudflared\functions\Install-Cloudflare.ps1
    }
    '2' {
        Write-Host "`nStarting service install."
        powershell -noexit -nologo -executionpolicy bypass -File C:\Cloudflared\cloudflared\functions\Install-Service.ps1
    }
    '3' {
        Write-Host "`nStarting service update."
        powershell -noexit -nologo -executionpolicy bypass -File C:\Cloudflared\cloudflared\functions\Update-Cloudflare.ps1
    }
    '4' {
        Write-Host "`nStarting service removal.."
        powershell -noexit -nologo -executionpolicy bypass -File C:\Cloudflared\cloudflared\functions\Remove-Service.ps1
    }
    '5' {
        Write-Host "`nStarting rule addition."
        powershell -noexit -nologo -executionpolicy bypass -File C:\Cloudflared\cloudflared\functions\Add-CloudflareRule.ps1
    }
    'Q' {
        Return
    }
